        ...
        <div id="cta-inner-container" class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
            <div id="cta-content" class="max-w-screen-sm mx-auto text-center">
                ...
                <div id="cta-subtitle-container" class="flex">
                    <p id="cta-subtitle" class="flex-1 mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">Optimize efficiency and reduce errors with our powerful build automation tool</p>
                </div>
                ...
                <div id="cta-button-container" class="flex space-x-4">
                    ...
                    <a href="#" class="flex-1 text-purple-700 bg-white hover:bg-gray-100 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 border border-purple-700 focus:outline-none">Free</a>
                </div>
            </div>
        </div>
    </section>
